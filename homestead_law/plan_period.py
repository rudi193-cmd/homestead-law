...
#: received` from a grant (L8-grant), `safe.amount`/`equity_grant.amount`/
#: `revenue_start` from a venture (L8-venture). A frozenset of field names,
#: not matter names, so it carries no I-23 exposure of its own.
#:
